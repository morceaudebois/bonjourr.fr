...
description: Time and date settings let you customize the clock appearance, format, and display multiple time zones with world clocks.
...
<img
	...
	src="/documentation/overview/regular-clock.png"
	alt="A customised clock in Bonjourr"
	loading="lazy"
/>
