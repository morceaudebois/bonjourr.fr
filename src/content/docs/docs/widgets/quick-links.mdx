...
## Importing and syncing your links {#importing-and-syncing-your-links}
...
## Change the look of your links {#change-the-look-of-your-links}
...
### Website favicon (default) {#website-favicon-default}
...
### Cache policy on quick links icons {#cache-policy-on-quick-links-icons}
