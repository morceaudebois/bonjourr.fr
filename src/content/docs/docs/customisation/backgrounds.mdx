---
title: Backgrounds
description: Backgrounds lets you customize your new tab appearance using curated image and video sources, Unsplash integrations, local files, remote URLs, solid colors, and texture overlays.
...
Bonjourr lets you fully customise your new tab experience with beautiful and dynamic backgrounds. Whether you prefer curated photos, immersive videos, or your own local files, there are plenty of options to make it feel personal.
...
3. Head back to Bonjourr and after having checked [**Show all settings**](/docs/quick-guide/#i-think-some-options-are-missing-what-do-i-do) at the top of the settings panel, paste the ID in the **Unsplash collection** field. You can add multiple collections by separating them with a comma.
