...
### Actifs dès le premier lancement {#active-on-first-start}

#### api.bonjourr.fr {#apibonjourrfr}
...
#### image.unsplash.com {#imageunsplashcom}
...
### Optionnels {#imageunsplashcom}

#### api.bonjourr.fr {#apibonjourrfr-1}
...
## Stockage des paramètres {#settings-storage}
...
## Service d'arrière-plan {#background-service}
